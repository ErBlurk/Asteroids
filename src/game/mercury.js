...
export class Mercury extends Actor 
{
    ...
    async InitMesh()
    {
        await this.LoadObj("/Asteroids/assets/objects/mercury.obj"); // Handles collision component 
        ...
        await this.LoadTexture("/Asteroids/assets/textures/mercury_diffuse.png", true);
